...
values
    ...
    ('04581230497', '1992-02-13','Carlos Gama Vieira', 'Marceneiro', 10),
    ('98563210054', '1991-04-30','Flavia Costa Vieira', 'Professora', 12);
...
values
    ...
    ('78953019000121', '2008-06-28','159741028', 'Casa de Carnes Ribeiro', 'Ribeiro Casa de carnes LTDA', 7),
    ('45237891000176', '2012-07-09','109872964', 'Lanchonete do Dito', 'Dito Comércio EIRELI ME', 8),
    ('76910302000138', '2009-05-12','875681049', 'Lava Jato Alto Brilho', 'Alto Brilho Limpeza ME', 9),
    ('24635702000116', '2015-11-27','156324750', 'Clinica Bela', 'Julia Beleza LTDA', 11),
    ('12036620000171', '2004-07-05','234568102', 'Indústria Tess', 'Tess Industria LTDA', 13);
...
values
    ...
    ('2006-03-12', 24587, 854.96, 7),
    ('1999-06-13', 87560, 542.63, 8),
    ('2005-11-26', 63204, 962.51, 9),
	('2003-06-10', 63210, 102.48, 10),
    ('1997-07-02', 10234,205.23, 11),
    ('2012-05-19', 75123,845.62, 12),
    ('2003-07-12', 40598,76.85, 13),
    ('2017-09-27', 30127,304.30, 14),
    ('2001-03-10', 20334,2087.22, 15),
    ('1999-07-17', 10872,30782.05, 16);
select * from conta;
